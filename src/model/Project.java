...
public class Project implements Serializable {
	...
	public Project(String acronym, String description, int fundingDuration,
			double budget, Users owner, Category category , int projectid) throws InvalidDataException {
		setAcronym(acronym);
	...
	*/
	...
	public void setOwner(Users owner) throws InvalidDataException {
		if(owner == null) {
			throw new InvalidDataException("Project must have an owner");
		}				
		this.owner = owner;
